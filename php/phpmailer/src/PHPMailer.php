...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/docs/assets/images/a.png"> and must not be empty
     * will look for an image file in $basedir/docs/assets/images/a.png and convert it to inline.
